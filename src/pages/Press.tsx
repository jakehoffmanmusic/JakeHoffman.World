    ...
    <div className="container press-grid-container" style={{ maxWidth: '1200px', margin: '0 auto', padding: '2rem' }}>
      <div className="press-grid">
        ...
        <div className="press-square text-square">
          <div className="square-content">
            <p>
              <strong>Natural State</strong> is an immersive concert I am producing. It is an evolving format which gives an audience the opportunity to intuitively explore music first hand and understand the pieces at play. 
            </p>
            <p>
